    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('manager.drivers.index') }}" :active="request()->routeIs('manager.drivers.index')">
                        {{ __('Driver') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('manager.locations.index') }}" :active="request()->routeIs('manager.locations.index')">
                        {{ __('Location') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('manager.types.index') }}" :active="request()->routeIs('manager.types.index')">
                        {{ __('Type') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('manager.cars.index') }}" :active="request()->routeIs('manager.cars.index')">
                        {{ __('Car') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('manager.rents.index') }}" :active="request()->routeIs('manager.rents.index')">
                        {{ __('Rent') }}
                    </x-jet-nav-link>
                </div>
            </div>
